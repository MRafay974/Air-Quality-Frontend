  ...
  // const HISTORICAL_API_URL = "http://localhost:5000/api/historical-data";
  ...
  //         console.log("🔍 Raw Real-time API Data:", JSON.stringify(data, null, 2));
  ...
  //           console.log("🔍 Updated Real-time Sensor Data:", updatedReadings);
  ...
  //         console.log("🔍 Raw Historical API Data:", JSON.stringify(data, null, 2));
  ...
  //       console.log("📊 Updated 1-Minute Trend Data:", JSON.stringify(newData, null, 2));
  //       return newData;
  //     });
  //   };
  ...
  //         <div className="p-4">
  //           <h1 className="font-bold text-4xl md:text-5xl mb-6 text-blue-400 text-center">DCE Ground Floor Left</h1>
